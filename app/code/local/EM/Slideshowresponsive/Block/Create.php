 ...
 * 
 */
class EM_Slideshowresponsive_Block_Create extends Mage_Core_Block_Template implements Mage_Widget_Block_Interface {
    ...
    protected function _toHtml() {
        ...
        $this->setTemplate('slideshowresponsive/slideshow.phtml');
