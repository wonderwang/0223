 ...
 */
class EM_Slideshowresponsive_WidgetController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function buildWidgetAction()
    {
        ...
        $html = Mage::getSingleton('slideshowresponsive/widget')->getWidgetDeclaration($type, $params, $asIs);
