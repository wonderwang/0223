<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v4.9.24' || 'working' == 'v4.5.41') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoomplus&license=trial&tool_version=v4.5.41&module_version=v4.9.24&platform_name=magento&platform_version={$platformVersion}&url={$url}";
